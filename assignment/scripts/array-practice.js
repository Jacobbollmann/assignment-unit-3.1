...
let favoriteFoods = ['Pizza', 'Pasta', 'Chicken', 'Anything Sweet'];
...
console.log('Second animal in animalArray is:', secondAnimal);
...
lastAnimal = animalArray[lastAnimal];
console.log(animalArray);
console.log(lastAnimal);
...
let gemsReversed = gems.sort();
gemsReversed = gems.reverse();
console.log('This is the gems reversed array:', gemsReversed);
